...
class lab_0_0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_0_0")
        ...
        # Blocks
        ##################################################
        self._A_range = Range(1, 5, 0.01, 3, 200)
        ...
        self.qtgui_number_sink_0_0_0_0_0.set_title('Desviacion estandar')
        ...
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, A, 0)
...
def main(top_block_cls=lab_0_0, options=None):
