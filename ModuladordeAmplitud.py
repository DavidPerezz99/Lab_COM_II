...
import sip
from envolventecomplea import envolventecomplea  # grc-generated hier_block
...
class ModuladordeAmplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.envolventecomplea_0 = envolventecomplea(
            Ac=Ac,
            ka=ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.envolventecomplea_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.practica3_0, 0))
        self.connect((self.envolventecomplea_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.envolventecomplea_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.envolventecomplea_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.envolventecomplea_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.envolventecomplea_0.set_ka(self.ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.envolventecomplea_0.set_Ac(self.Ac)
